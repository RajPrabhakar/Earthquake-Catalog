...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String formattedMagnitude = formatMagnitude(currentWord.getqMagnitude());
        magnitude.setText(formattedMagnitude);

        GradientDrawable magnitudeCircle = (GradientDrawable) magnitude.getBackground();
        int magnitudeColor = getMagnitudeColor(currentWord.getqMagnitude());
        magnitudeCircle.setColor(magnitudeColor);

        String originalLocation = currentWord.getqLocation();
        ...
        Date dateObject = new Date(currentWord.getqMilliSeconds());
